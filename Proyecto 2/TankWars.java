...
public class TankWars {
    public static void main(String[] args) {
        Scanner NesOsp = new Scanner(System.in);
        String salida = "\n1. Rocket Launcher\n"+
        ...
        while(true){ 
            ...
            if(Tanque.muertos()==Tanque.tanquesEnLista()){
                System.out.println("\nJuego Finalizado\n");
                break;
            }
            System.out.println("\nDigita la opcion que desea realizar\n");
            opcion = NesOsp.nextInt();
        }
        NesOsp.close();
    }
}